                    ...
                    <div id="mynavbar" class="navbar-collapse collapse">
                        <div id="menu-1" class="col-md-offset-1 col-md-5 ">
                            <ul id="bootstrap-menu" class="nav navbar-nav">
                                ...
                                <li id="menu-home" class="active page-scroll"><a href="#myheader">HOME</a></li>                                                                                                                  
                                <li id="menu-about" class="page-scroll" data-offset="100"><a href="#about">ABOUT</a></li>

                                <!--Books-->
                                <li id="menu-book" class="dropdown page-scroll"><a class="dropdown-toggle" data-toggle="dropdown" href="#book">BOOKS&nbsp;<span class="glyphicon glyphicon-chevron-down"></span></a>
                                ...
                                <!--Clients-->
                                <li id="menu-client" class="dropdown page-scroll"><a class="dropdown-toggle" data-toggle="dropdown" href="#client">CLIENTS&nbsp;<span class="glyphicon glyphicon-chevron-down"></span></a>
                                    <ul class="dropdown-menu submenu">                                
                                ...
                                <li id="menu-contact" class="page-scroll"><a href="#contact">CONTACT</a></li>
                            </ul>
                        </div>
                        <div id="menu-2">
                            <!-- Contact -->
